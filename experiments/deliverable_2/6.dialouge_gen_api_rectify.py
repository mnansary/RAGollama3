...
template = """You are tasked with converting a set of question-answer pairs into a natural conversation format. 
            ...
            MAKE SURE THAT THE "Question" AND "Answer" is always present at the start of each line of the conversation
            ...
            Question: বাংলা ভাষার সাথে সম্পর্কিত কোন দেশগুলির কথা শুনেছো?\n
            Answer: বাংলা ভাষার সাথে সম্পর্কিত ১০টি দেশ আছে। যেমন: বাংলাদেশ, ভারত, ইউনাইটেড কিংডম, যুক্তরাষ্ট্র, পাকিস্তান, ওমান, ইন্দোনেশিয়া, ব্রুনেই, মালয়েশিয়া, এবং সিংগাপুর।\n
            Question: ওহ, বাংলা ভাষার সাথে কি ধরনের ভাষা সম্পর্কিত?\n
            Answer: বাংলা ভাষা ইন্দো-আর্য ভাষাগুলোর একটি অংশ।\n
            Question: সত্যি? তাহলে বাংলা ভাষার অবস্থান সম্পর্কে কিছু বলো।\n
            Answer: অবশ্যই! জনসংখ্যার ভিত্তিতে, বাংলা ভাষা পৃথিবীর অন্যতম বৃহৎ ভাষা। এটি মাতৃভাষা হিসেবে চতুর্থ স্থান দখল করে আছে।\n
        ...
        try:
            ...
            for line in conversation.strip().split("\n"):
                ...
                if ":" in line:
                    ...
                    if speaker=="Question": speaker="A"
                    if speaker=="Answer": speaker="B"
...
if __name__ == "__main__":
    ...
    SAVE_DIR="/home/vpa/deliverables/__archive__/DiaGenD3_REST/bccData"
